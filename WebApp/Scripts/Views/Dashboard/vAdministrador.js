...
function RenderCharts() {
    ...
    GetData(DrawBarChart, "Report/GetReportAllGananciasTipoTransaccion");
    GetData(DrawPieChart, "Report/GetReportAllTransactionsByTarjeta");
}
...
function DrawBarChart(obj) {
    ...
    var objToShow = GetUniqueData(obj.Data);
    var myLineChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: objToShow.Label,
            datasets: [{
                label: "Cantidad de transacciones",
                backgroundColor: getRandomColor(),
                borderColor: "rgba(2,117,216,1)",
                data: objToShow.Values,
            }],
        },
        options: {
            scales: {
...
function DrawPieChart(obj) {
    ...
    var myPieChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                data: objToShow.Values,
                backgroundColor: Colors(objToShow.Label),
            }],
        },
    });
}
