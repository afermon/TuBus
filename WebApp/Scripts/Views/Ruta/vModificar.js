function vModificar() {
    ...
    this.serviceUpdate = "Ruta/Update";
    ...
    this.Update = function () {
        if (!$("#frmEdition").valid()) {
            ...
            if (directionsRequest) {
                rutaData["JsonRoute"] = JSON.stringify(directionsRequest);
            } else {
            ...
            this.ctrlActions.PutToAPI(this.serviceUpdate, rutaData, function () {
    ...
    this.BindFieldsRuta = function (data) {
        ...
        horarios.forEach(function (h, index, ha) {
            ha[index].Hora = h.Hora.substring(0, h.Hora.length - 3);
        });
        this.DrawHorario();
    ...
    this.FillComboBoxes = function () {
        ...
        this.FillLineas(true);
    }

    this.FillLineas = function (ts = false) {
        if (ts && this.empresa == null)
            this.serviceLineas = "Linea/GetAllLines";
        else
            this.serviceLineas = this.empresa == null ? 'Linea/GetAllLines?empresaId=' + $("#cbEmpresa").val() : 'Linea/GetAllLines?empresaId=' + this.empresa.CedulaJuridica;
...
function calcRoute(request = null) {
    if (destinoMarker !== false) {
...
$(document).ready(function () {
    var vmodificar = new vModificar();
    vmodificar.FillComboBoxes();
    vmodificar.Retrieve();
    vmodificar.GetTarifa();
